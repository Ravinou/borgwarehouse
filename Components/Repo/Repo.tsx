                ...
                <tr>
                  ...
                  <th>
                    <div className={classes.lastSave}
                        title={props.lastSave === 0 ? '' : fromUnixTime(props.lastSave).toLocaleString()}>
        ...
        <>
          <div className={classes.RepoClose}>
            ...
            <div className={classes.lastSave}>
                <span
                   title={props.lastSave === 0 ? '' : fromUnixTime(props.lastSave).toLocaleString()}>
                      {props.lastSave === 0 ? '-' : formatDistanceStrict(fromUnixTime(props.lastSave), Date.now(), { addSuffix: true })}</span>
